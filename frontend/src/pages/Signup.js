...
function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const url = "http://localhost:8080/auth/signup"; // ✅ must be lowercase
      ...
      if (success) {
        ...
        // Joi error handling: error.details[0].message
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleSignup}>
        ...
        {/* Signup button disabled until all fields are filled */}
        <button
          type="submit"
          disabled={
